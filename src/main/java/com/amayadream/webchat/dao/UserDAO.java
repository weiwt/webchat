...
public interface UserDAO {
    ...
    @Options(useCache = false,keyProperty = "entity.userId")
    int insert(@Param("entity") User user);

    @Update({"update ",TABLE_NAME," set nickName= #{entity.nickName},sex = #{entity.sex},age = #{entity.age},profile = #{entity.profile} where userId = #{entity.userId}"})
